...
export default function UploadCard() {
  return (
    <div className="lg:col-span-2 bg-cardDark rounded-xl p-6 border-l-4 border-neonCyan space-y-4 shadow-[0_0_10px_rgba(34,211,238,0.2),inset_4px_0_3px_1px_rgba(34,211,238,0.1)]" >
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-2">
          <img src={ResumeAnalysis} alt="Resume Analysis"/>
          <h3 className="font-semibold text-[18px] font-sans">Resume Analysis</h3>
        </div>
      ...
      <div className="border border-dashed border-[rgba(51,61,85,1)] rounded-lg p-8 text-center space-y-3 bg-cardDark/50">
